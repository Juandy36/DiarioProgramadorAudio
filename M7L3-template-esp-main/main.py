...
@app.route('/form_audio', methods=['POST'])
def form_audio():
    try:
        textgotten = audio()
    except Exception as e:
        textgotten = print(f'error{str(e)}')
        
    return render_template('create_card.html', textgotten = textgotten)
